-- 1. Revert enforce_free_plan_quota to its strict state (without v_is_developer logic)
...
-- 2. Drop the is_developer column completely to prevent any further bypasses
ALTER TABLE public.profiles DROP COLUMN IF EXISTS is_developer;
