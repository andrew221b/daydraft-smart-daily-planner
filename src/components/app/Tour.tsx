  ...
  steps: [
    {
      ...
      title: "Plan your day",
      body: "Tap Edit plan to brain-dump tasks and generate a timed schedule. Your timer lives on the Track tab for quick logging.",
      placement: "bottom",
    },
    {
      id: "tab-home",
      ...
      title: "Track",
      body: "This is the spine of DayDraft: start time, see today and week totals, and open the full tracker. Plan is optional support.",
      placement: "top",
    },
    {
      id: "tab-history",
