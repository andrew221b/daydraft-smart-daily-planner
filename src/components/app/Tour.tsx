...
export const TOUR_TODAY: TourFlow = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "History",
      body: "Every day you've planned, in one place. Tap any date to revisit what you did.",
      placement: "top",
    },
    {
      id: "tracker",
    ...
    },
    {
      ...
      body: "See where your hours actually go, your peak focus times, and what tends to slip.",
      placement: "top",
    },
    {
      id: "tab-settings",
      ...
      title: "Settings",
      body: "Profile, theme, notifications, your subscription — everything lives here.",
      placement: "top",
    },
  ],
};
