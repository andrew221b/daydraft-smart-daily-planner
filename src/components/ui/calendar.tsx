    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 rounded-full opacity-60 hover:opacity-100 border-border",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-9 font-medium text-[0.7rem] uppercase tracking-wider",
        ...
        day_today: "bg-transparent text-primary font-semibold ring-1 ring-primary/40 rounded-full",
        day_outside:
