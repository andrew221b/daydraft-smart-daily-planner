...
const COPY: Record<Tone, Record<string, string>> = {
  professional: {
    ...
    start_next: "Focus on next block",
    recap_cta: "Open recap",
    track_label: "Track time on this",
    replan_rest_cta: "Adjust my plan for the rest of today",
  ...
  coach: {
    ...
    replan_rest_cta: "Coach me through the rest of today",
  ...
  playful: {
    ...
    replan_rest_cta: "Tidy up what's left ✨",
  ...
  motivational: {
    ...
    replan_rest_cta: "Recover momentum for what's left",
  ...
  tough_love: {
    ...
    replan_rest_cta: "Reset and execute what's left",
